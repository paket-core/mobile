            ...
            switch(Type)
            {
                ...
                case AssetTypeEnum.ASSET_TYPE_CREDIT_ALPHANUM4:
                    return new Generated.Asset
                    {
                        ...
                        {
							AssetCode = Encoding.UTF8.GetBytes(Code),
        ...
        public static Asset FromXDR(Generated.Asset asset)
        {
            switch(asset.Discriminant.InnerValue)
            {
                ...
                case Generated.AssetType.AssetTypeEnum.ASSET_TYPE_CREDIT_ALPHANUM4:
					var bytesAN4 = asset.AlphaNum4.AssetCode;
					return new Asset(Encoding.UTF8.GetString(bytesAN4, 0, bytesAN4.Length), KeyPair.FromXdrPublicKey(asset.AlphaNum4.Issuer.InnerValue));
                case Generated.AssetType.AssetTypeEnum.ASSET_TYPE_CREDIT_ALPHANUM12:
					var bytesAN12 = asset.AlphaNum12.AssetCode;
					return new Asset(Encoding.UTF8.GetString(bytesAN12, 0, bytesAN12.Length), KeyPair.FromXdrPublicKey(asset.AlphaNum12.Issuer.InnerValue));
                default:
                    throw new ArgumentException("Invalid asset.");
            }
        }
